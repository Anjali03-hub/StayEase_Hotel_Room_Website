...
<div class="content">
<h2 class="fw-bold h-font text-center" >User Registration</h2>
            ...
            <div className="w-70 vh-40 bg-white justify-content-center rounded p-4 ">
              ...
              <table class="table  border-1 table-hover ">
                ...
                {
                    users.map((user)=>{
                        return <tr><td>{user._id}</td><td>{user.firstname}</td><td>{user.lastname}</td><td>{user.email1}</td><td>{user.mobileno}</td>
                       <td>{user.birthdate}</td><td>{user.gender}</td><td>{user.address}</td> <td>{user.password1}</td><td>{user.conform}</td><td>
